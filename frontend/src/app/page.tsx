      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-zinc-400 dark:text-zinc-400 text-zinc-600 text-lg">
            Powered by Qwen-Agent and Qwen via Alibaba Cloud Model Studio
          </p>
          <div className="flex items-center justify-center gap-2 mt-3">
            ...
            <span className="px-3 py-1 bg-violet-500/10 text-violet-400 dark:text-violet-400 text-violet-600 rounded-full text-xs font-medium border border-violet-500/20">Qwen</span>
